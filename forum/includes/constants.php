...
//SP-
define('BLACKLIST_TABLE',			$table_prefix . 'blacklist');
define('BRANDS_TABLE',				$table_prefix . 'brands');
define('CATALOGS_TABLE',			$table_prefix . 'catalogs');
define('DOGS_TABLE',				$table_prefix . 'dogovor');
define('EVENTS_TABLE',				$table_prefix . 'events');
define('EVENTS_TO_TABLE',			$table_prefix . 'events_to');
define('EVENTS_TYPE_TABLE',			$table_prefix . 'events_type');
define('INFO_TABLE',				$table_prefix . 'info');
define('LOTS_TABLE',				$table_prefix . 'lots');
define('ORDERS_TABLE',				$table_prefix . 'orders');
define('PRODUCTCAT_TABLE',			$table_prefix . 'productcat');
define('PURCHASES_TABLE',			$table_prefix . 'purchases');
define('PURCHASES_ORSERS_TABLE',	$table_prefix . 'purchases_orsers');
//define('REPORTS_TABLE',				$table_prefix . 'reports');
define('RESERVS_TABLE',				$table_prefix . 'reservs');
//-SP

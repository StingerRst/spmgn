				...
				switch ($step)
				{
					...
					case 1:
						...
						$template->assign_vars(array(
							...
							'S_FIELD_FS_SHOW'	=> $cp->vars['field_fs_show'],
							'S_DISPLAY_FIELD_FS_SHOW'	=> in_array($field_type, array(FIELD_STRING, FIELD_BOOL, FIELD_DROPDOWN)),
							)
							//END MOD
						);
	...
	*/
	function save_profile_field(&$cp, $field_type, $action = 'create')
	{
		...
		$profile_fields = array(
			...
			'field_fs_show'			=> $cp->vars['field_fs_show'],
			//END MOD
		);

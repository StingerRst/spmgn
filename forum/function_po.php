...
if ($user->data['user_id'] == ANONYMOUS)
	...
	switch ($_POST['cmd']) {
		case 'orders_count':
			$sql = 'SELECT  COUNT(*) AS cnt FROM phpbb_orders WHERE order_status <> 3 AND  Purchase_id ='.$_POST['purchase_id'];
...
<br><br>			'.$a['news'].'
<br><br>			<span style="color:blue; font-size: 180%; line-height: 116%; text-decoration: underline;">Каталоги:</span>
<br>			'.$a['cat'].'

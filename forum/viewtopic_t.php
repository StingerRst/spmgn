...
/* ==== Super Quick Reply START ==== */
if(!$s_quick_reply)
{
  include($phpbb_root_path.'includes/super_quick_reply.'.$phpEx);
  $SuperQuickReply = new SuperQuickReply($topic_id, $forum_id, $topic_data);
}

/* ===== Super Quick Reply END ===== */
...
$template->set_filenames(array(
	'body' => ($view == 'print') ? 'viewtopic_print.html' : 'viewtopic_body_t.html')
);
